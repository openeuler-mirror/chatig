...
#[openapi(
    ...
    components(
        schemas(Model,ChatCompletionRequest,Message,ErrorResponse,EmbeddingRequest,EmbeddingResponse,EmbeddingData,Usage,ModelErrorDetails,ModelErrorName,DeleteFileResponse,FileObject)
    )
)]
