...
use crate::cores::models::image_generation::image_controller::{ImageGenerationRequest, ImageGenerationResponse};
use crate::cores::models::image_generation::image_controller::ImageProvider;
...
impl ImageProvider for SdxlTurbo {
    async fn image_provider(&self, req_body: web::Json<ImageGenerationRequest>) -> Result<ImageGenerationResponse, String> {
        ...
        let service = service_manager.get_service_by_model(&req_body.model, None, "[]".to_string())
            .await
