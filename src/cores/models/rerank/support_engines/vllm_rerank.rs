...
use crate::cores::models::rerank::rerank_controller::{VLLMRerankTrait, VLLMRerankRequest};
use crate::cores::utils::get_response;

pub struct VLLMRerank{
    pub active_model: String,
}

#[async_trait]
impl VLLMRerankTrait for VLLMRerank {
