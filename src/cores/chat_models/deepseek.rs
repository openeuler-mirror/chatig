...
// Handle non-streaming response requests
async fn completions_response_non_stream(response: Response, userid: String, curl_mode: String, appkey: String, start_time: DateTime<Tz>) -> Result<HttpResponse, Error> {
...
// Handle streaming response requests
async fn completions_response_stream(response: Response, userid: String, curl_mode: String, appkey: String, start_time: DateTime<Tz>) -> Result<HttpResponse, Error> {
